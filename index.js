...
app.get('/admin', (req, res) => {
  ...
  .select(
    ...
    knex.raw('ARRAY_AGG(DISTINCT "Affiliation_Num"::VARCHAR) AS Affiliation_Num'),
    knex.raw('ARRAY_AGG(DISTINCT ao.Organization_Description::VARCHAR) AS Organization_Description'),
    'pd.SM_Use',
    knex.raw('ARRAY_AGG(DISTINCT pp.Platform_Num::VARCHAR) AS Platform_Num'),
    knex.raw('ARRAY_AGG(DISTINCT p.Platform_Name::VARCHAR) AS Platform_Name'),
    'pd.SM_Time',
    'pd.SM_No_Purpose',
    'pd.SM_Distraction',
